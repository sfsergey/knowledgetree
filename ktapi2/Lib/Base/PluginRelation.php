...
class Base_PluginRelation extends Doctrine_Record
{
    ...
    {
        parent::setUp();
        $this->hasOne('Base_Plugin as Plugin', array('local' => 'plugin_namespace', 'foreign' => 'namespace', 'onDelete'=>'CASCADE', 'onUpdate'=>'CASCADE'));
        $this->hasOne('Base_Plugin as RelatedPlugin', array('local' => 'related_plugin_namespace', 'foreign' => 'namespace', 'onDelete'=>'CASCADE', 'onUpdate'=>'CASCADE'));
    }

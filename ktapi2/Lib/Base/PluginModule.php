...
class Base_PluginModule extends Doctrine_Record
{
    ...
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('module_type', 'enum', null, array('fixed' => false, 'values' =>  array(  0 => 'Action', 1 => 'Trigger', 2 => 'Table', 3 => 'Field'  ), 'primary' => false, 'default' => '', 'notnull' => true, 'autoincrement' => false));
